/******************************************************************************
 * Compilation: javac SplayBST.java Execution: java SplayBST Dependencies: none
 * 
 * Splay tree. Supports splay-insert, -search, and -delete. Splays on every
 * operation, regardless of the presence of the associated key prior to that
 * operation.
 *
